...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_BASE_LAYER] = KEYMAP( /* Base */
    ...
    KC_LCTL,KC_LGUI, KC_LALT,      LT(_ARROW_LAYER, KC_SPC),             KC_RALT,  MO(_FN_LAYER),  KC_RGUI, KC_RCTL
  ),
  /*
  * Layer _MAC_LAYER
  * ,-----------------------------------------------------------------------------------------.
  ...
  */
  [_ARROW_LAYER] = KEYMAP( /* Base */
    ...
    KC_HOME, KC_PGUP, KC_UP, KC_PGDN, KC_END, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_END,  KC_TRNS,
    KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_PGUP, KC_PGDN,         KC_TRNS,
